...
# DATE CREATED: 8 Aug 22                                  
# REVISED DATE: 8 Aug 22
...
#       with this function
# 
def get_pet_labels(image_dir, debug=False):
    """
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           pet_label = ' '.join(in_files[idx].lower().split('.')[0].split('_')[:-1])
...
if __name__ == "__main__":
    get_pet_labels('./pet_images',debug=True)

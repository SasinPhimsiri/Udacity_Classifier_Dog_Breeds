...
#                                                                             
# PROGRAMMER: Sasin Phimsiri
# DATE CREATED: 9 Aug 22                                 
# REVISED DATE: 13 Aug 22  
...
def adjust_results4_isadog(results_dic, dogfile, debug=False):
    """
    ...
    if debug == True:
        print('adjust_results4_isadog =',results_dic, '\n')
...
if __name__ == "__main__":
    ...
    classify_images(images_dir=images_dir, 
                    results_dic=results, 
                    model=model, 
                    debug=debug)
    adjust_results4_isadog(results_dic=results,
                           dogfile=dogfile, 
                           debug=debug)